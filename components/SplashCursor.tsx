...
// Theme palette (normalized to 0–1)
const THEME_COLORS: ColorRGB[] = [
  { r: 78 / 255,  g: 86 / 255,  b: 80 / 255  }, // #4e5650
  { r: 39 / 255,  g: 54 / 255,  b: 53 / 255  }, // #273635
  { r: 93 / 255,  g: 129 / 255, b: 76 / 255  }, // #5d814c
  { r: 87 / 255,  g: 112 / 255, b: 71 / 255  }, // #577047
];
...
export default function SplashCursor({
  ...
  BACK_COLOR = { r: 39 / 255, g: 54 / 255, b: 53 / 255 }, // #273635
  TRANSPARENT = true
}: SplashCursorProps) {
  ...
  useEffect(() => {
    ...
    /**
     * Picks a random color from the theme palette and applies a brightness
     * multiplier so the fluid remains vivid but consistent with the palette.
     */
    function generateColor(): ColorRGB {
      const base = THEME_COLORS[Math.floor(Math.random() * THEME_COLORS.length)];
      // Very dim — barely visible, stays well within the dark earthy theme
      const boost = 0.06 + Math.random() * 0.09; // range [0.06, 0.15]
      return {
        r: base.r * boost,
        g: base.g * boost,
        b: base.b * boost,
