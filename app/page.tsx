    ...
    >
      ...
      <div
        style={{
          position: "fixed",
          inset: 0,
          backgroundImage: "radial-gradient(circle, rgba(125,160,96,0.10) 1px, transparent 1px)",
      ...
      <div
        style={{
          ...
          height: 600,
          borderRadius: "50%",
          background: "radial-gradient(circle, rgba(93,129,76,0.08) 0%, transparent 70%)",
          top: "50%",
          left: "50%",
      ...
      >
        ...
        <div
          style={{
            ...
            alignItems: "center",
            gap: 8,
            border: "1px solid rgba(125,160,96,0.35)",
            padding: "6px 16px",
            borderRadius: 999,
            marginBottom: "2rem",
          }}
        ...
        >
          Something{" "}
          <em style={{ fontStyle: "italic", color: "#7da060" }}>
            Extraordinary
          </em>{" "}
          Is Cooking.
        </h1>
        ...
        <div
          style={{
            width: 48,
            height: 2,
            background: "linear-gradient(to right, #5d814c, transparent)",
            margin: "1.5rem auto",
            borderRadius: 2,
          }}
        />
        ...
        >
          RecipeRaja is being handcrafted — the same way we cook.
          Slowly, carefully, with no shortcuts. Check back soon for
          200+ authentic South Indian dishes.
        </p>

        {/* Tags */}
        <div style={{ display: "flex", flexWrap: "wrap", gap: 8, justifyContent: "center", marginBottom: "2.5rem" }}>
          {["Zero Preservatives", "100% Homemade", "Ships Pan India"].map((t) => (
            <div
              key={t}
              style={{
                display: "flex",
            ...
            >
              <span style={{ width: 5, height: 5, background: "#5d814c", borderRadius: "50%", flexShrink: 0 }} />
              {t}
            </div>
          ))}
        </div>

        <p style={{ fontFamily: "'Playfair Display', serif", fontStyle: "italic", fontSize: 13, color: "#5d814c", letterSpacing: "0.04em" }}>
          RecipeRaja · Since 1982 · Chennai
        </p>
      </div>
